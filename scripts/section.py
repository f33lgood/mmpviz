class Section:
    ...
    def _should_element_be_hidden(self, attribute):
        ...
        if val in ('False', 'no', 'false'):
            return False
        return self.size_y < 20

    def is_address_hidden(self):
        return self._should_element_be_hidden(self.style.get('hide_address', 'auto'))

    def is_name_hidden(self):
        return self._should_element_be_hidden(self.style.get('hide_name', 'auto'))
