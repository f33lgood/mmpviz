...
- **Per-section colors** — full visual control through `theme.json` without touching diagram data. Three built-in themes: `light`, `monochrome`, `plantuml`.
...
Built-in themes in `themes/`: `light.json`, `monochrome.json`, `plantuml.json`
